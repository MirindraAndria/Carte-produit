...
fun ProduitCard(produit: Produit) {
    ...
    // TODO A — FAIT :
    // état déclaré EN HAUT de la fonction (au-dessus de la Card),
    // avec remember pour qu'il survive aux recompositions.
    var quantite by remember { mutableStateOf(0) }

    // TODO B — FAIT :
    // état booléen déclaré ici, à côté de "quantite", avec remember
    // pour qu'il survive aux recompositions.
    ...
    Card(
        ...
        Column(Modifier.padding(16.dp)) {
            ...
            // TODO A — FAIT :
            // le Text lit désormais l'état "quantite", et le Button
            // l'incrémente au clic. C'est cette lecture de l'état dans
            // le corps du composable qui rend ProduitCard "observateur"
            // de "quantite" : Compose sait qu'il doit le recomposer
            // quand "quantite" change.
